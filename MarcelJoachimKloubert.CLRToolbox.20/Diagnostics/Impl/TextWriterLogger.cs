...
namespace MarcelJoachimKloubert.CLRToolbox.Diagnostics.Impl
{
    ...
    /// </summary>
    public class TextWriterLogger : LoggerFacadeBase
    {
        #region Fields (2)
        ...
        public delegate void TextWriterAction(TextWriterLogger logger, TextWriter writer);
        ...
        public delegate TextWriter TextWriterProvider(TextWriterLogger logger);
        ...
        /// <summary>
        /// Gets the optional disposer for the result of <see cref="TextWriterLogger.Provider" />.
        /// </summary>
        ...
        /// <summary>
        /// The provider for the text writer that should be used by <see cref="TextWriterLogger.OnLog(ILogMessage)" /> method.
        /// </summary>
        ...
        /// </exception>
        public static TextWriterLogger Create(TextWriter writer)
        {
        ...
        /// </exception>
        public static TextWriterLogger Create(TextWriter writer, object syncRoot)
        {
            return Create(writer, true, syncRoot);
        }
        ...
        /// <paramref name="writer" /> is <see langword="null" />.
        /// </exception>
        public static TextWriterLogger Create(TextWriter writer, bool isThreadSafe)
        {
            return Create(writer, isThreadSafe, new object());
        }
        ...
        /// <paramref name="writer" /> and/or <paramref name="syncRoot" /> are <see langword="null" />.
        /// </exception>
        public static TextWriterLogger Create(TextWriter writer, bool isThreadSafe, object syncRoot)
        {
            if (writer == null)
            {
            ...
            return new TextWriterLogger(delegate(TextWriterLogger logger)
                                        {
                                            return writer;
                                        }, null
                                         , isThreadSafe
        ...
        {
            TextWriter writer = this._PROVIDER(this);
            if (writer == null)
            {
                return;
            }
