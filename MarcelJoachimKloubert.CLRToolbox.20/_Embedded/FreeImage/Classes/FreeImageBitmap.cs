...
namespace FreeImageAPI
{
	...
	public class FreeImageBitmap : MarshalByRefObject, ICloneable, IDisposable, IEnumerable, ISerializable
	{
		...
		/// Width or height of <paramref name="newSize"/> are less or equal zero.
		/// </exception>
		...
		/// <exception cref="ArgumentException">Length of <paramref name="lookUpTable"/> is not 256.</exception>
