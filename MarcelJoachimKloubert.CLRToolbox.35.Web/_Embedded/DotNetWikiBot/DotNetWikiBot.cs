...
namespace DotNetWikiBot
{
	...
	public class Bot
	{
        ...
        /// <param name="startMark">Substring that the resultant string
		/// must begin with. Can be null or empty, in this case the source string is returned
		/// from the very beginning.</param>
        /// <param name="endMark">Substring that the resultant string
...
#else
            settings.DtdProcessing = global::System.Xml.DtdProcessing.Parse;
#endif
