...
namespace MarcelJoachimKloubert.CLRToolbox.Extensions
{
    static partial class ClrToolboxExtensionMethods
    {
        ...
        /// 
        /// </summary>
        /// <see cref="CollectionHelper.ForAll{T, S}(IEnumerable{T}, Action{IForAllItemExecutionContext{T, S}}, Func{T, S})" />
        public static AggregateException ForAll<T, S>(this IEnumerable<T> items,
                                                      Action<IForAllItemExecutionContext<T, S>> action,
        ...
        /// 
        /// </summary>
        /// <see cref="CollectionHelper.ForAll{T, S}(IEnumerable{T}, Action{IForAllItemExecutionContext{T, S}}, Func{T, S}, bool)" />
        public static AggregateException ForAll<T, S>(this IEnumerable<T> items,
                                                      Action<IForAllItemExecutionContext<T, S>> action,
                                                      Func<T, S> actionStateFactory,
                                                      bool throwExceptions)
